                ...
                <div class="second-nav">
                    <div class="grid_12">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="#" class="active">Admin</a></li>
                            </ul>
                       ...
                       <tr>
                           ...
                           <td><select name="category">
                               ...
                               <option value="" disabled <?php
                                       ...
                                       if(!isset($_POST['category'])) echo'selected';
                                       
                                       ?>>select</option>
                               <option value="1" <?php
                                       if(isset($_POST['category']) and $_POST['category']=='1') echo 'selected';                                       
                                       ?>  >Education</option>
                               <option value="2"<?php
                                       if(isset($_POST['category']) and $_POST['category']=='2') echo 'selected';                                       
                                       ?>>Entertainment</option>
                               <option value="3"<?php
                                       if(isset($_POST['category']) and $_POST['category']=='3') echo 'selected';                                       
                                       ?>>Sports</option>
                               <option value="4"<?php
                                       if(isset($_POST['category']) and $_POST['category']=='4') echo 'selected';                                       
                                       ?>>Music</option>
                               <option value="5"<?php
                                       if(isset($_POST['category']) and $_POST['category']=='5') echo 'selected';                                       
                                       ?>>Technology</option>
                               <option value="6"<?php
                                       if(isset($_POST['category']) and $_POST['category']=='6') echo 'selected';                                       
                                       ?>>Party</option>
