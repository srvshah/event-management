            ...
            <!--second nav-->
                <div class="second-nav">
                    <div class="grid_12">
                            ...
                            <ul>
                                <li><a href="admin_area.php" class="active">Home</a></li>
                                <li><a href="admin/admin_about.php">About</a></li>
                                <li><a href="admin/admin_contact.php">Contact</a></li>
                                <li><a href="admin/admin_event.php">Events</a></li>
                                <li><a href="admin/admin_home.php">Admin</a></li>
                            </ul>
